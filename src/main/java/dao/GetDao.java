...
public class GetDao
{
	public Users getUser(int emp_no)
	{
		...
		try
		{
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://java-tomcat.c5ll7h0slf4d.ap-south-1.rds.amazonaws.com:3306/db","admin","AWSDevOps#123");
			// Connection con = DriverManager.getConnection("jdbc:mysql://java-tomcat:3306/db","root","AWSDevOps#123");
			/*
